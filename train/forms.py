...
class AddTrain(FlaskForm):
    ...
    acFirstClassCoaches = StringField('AC First Class',validators=[DataRequired()])
    acFirstClassFare = StringField('AC First Class Fare',validators=[DataRequired()])
    acTwoTierCoaches =  StringField('AC 2 Tier',validators=[DataRequired()])
    acTwoTierFare = StringField('AC 2 Tier Fare',validators=[DataRequired()])
    acThreeTierCoaches =  StringField('AC 3 Tier',validators=[DataRequired()])
